...
const TopBar = () => (
    <header className="fixed top-0 w-full h-16 bg-white shadow-sm z-50">
      <div className="max-w-7xl mx-auto h-full px-4 flex items-center justify-between">
        <h1 className="text-2xl font-bold">Soundstation</h1>
        <div className="flex-1 max-w-xl mx-8">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border rounded-full bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-600"
            />
          </div>
        </div>
